    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-slate-300 bg-slate-50 py-12 dark:border-slate-700 dark:bg-slate-800/50">
          ...
          {searchQuery ? (
            <>
              <h3 className="font-medium text-slate-900 dark:text-white">No starred files found</h3>
            ...
            <>
              <h3 className="font-medium text-slate-900 dark:text-white">No starred files yet</h3>
              <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
